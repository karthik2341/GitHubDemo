...
public class PricingLevel006 {
	...
	public void pricinglevel006() throws Exception{
		...
		pe.pricingRules_SelectUserDefinedCode("006");
		...
		pe.setValues_PriceRuleImportMaintenance(er.getCellData(filePath, "Global", "cRulesEffDate", 3), er.getCellData(filePath, "Global", "cRulesTermDate", 3), er.getCellData(filePath, "Global", "cItemNumber", 2),"C","10.0000","","","","6");
		...
		pe.PI_getPrice(er.getCellData(filePath, "Global", "cBillToCustomer", 2),er.getCellData(filePath, "Global", "cItemNumber", 2),er.getCellData(filePath, "Global", "cRulesEffDate", 3));
		//Verify the Price Rule
		hr.writeStepInformation("Step 9 : Verify the Price Rule is populated or not");
		pe.verify_PriceRule("6");

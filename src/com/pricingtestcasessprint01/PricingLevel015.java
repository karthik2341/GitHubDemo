package com.pricingtestcasessprint01;
	...
	public class PricingLevel015 {
		...
		@Test
		public void pricinglevel015() throws Exception{
			try{
			//Classes Creation		
			WebControls wc = new WebControls();
			...
			pe.setValues_PriceRuleImportMaintenance(er.getCellData(filePath, "Global", "cRulesEffDate", 6), er.getCellData(filePath, "Global", "cRulesTermDate", 6),"F",er.getCellData(filePath, "Global", "cItemNumber", 2),"F","110.0000",er.getCellData(filePath,"Global","cProdCat",2),"N","15");
